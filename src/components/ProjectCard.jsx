...
const ProjectCard = ({
  ...
  return (
    <div className={"relative p-5 cursor-pointer rounded-2xl bg-zinc-800 hover:bg-zinc-700/50 active:bg-zinc-700/60 ring-1 ring-inset ring-zinc-50/5 transition-colors " + classes}>
      ...
      <div className="flex items-center justify-between gap-4">
        ...
        <div className="w-12 h-20 gap-1 sm:gap-2 rounded-lg grid place-items-center shrink-0">
            <a 
                href={projectLinks.github}
                target='_blank'
                className='w-10 h-10 grid transition-[background-color,color] place-items-center rounded-lg hover:bg-zinc-100 hover:text-zinc-950 active:bg-zinc-50/80 ring-inset ring-2 ring-zinc-50/10'
            >
                {github.icon}
            </a>
            <a 
